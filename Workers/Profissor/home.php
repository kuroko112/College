<?php 
    ...
    $query  = "SELECT name_doc FROM professor WHERE email_doc = '$username'";
    ...
    echo "<h1 style='text-align:center;'> home page professor <br> wlcome ". $username  . " </h1> <br><br><br><br>";
?>
...
<form  method="post">
    ...
    <tr>
        ...
        <td><button style="background:deepskyblue; height:50px; color:white;width:100% "  name="add_sco" >Scoring page</button></td>
